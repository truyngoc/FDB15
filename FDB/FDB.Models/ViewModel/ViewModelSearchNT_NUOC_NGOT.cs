...
{
    public class ViewModelSearchNT_NUOC_NGOT
    {
        ...
        public IPagedList<NT_NUOC_NGOT> SearchResults { get; set; }
    ...
    public class ViewModelBaoCaoNT_NUOC_NGOT
    {
        public int? Page { get; set; }
        ...
        public List<ViewModelBaoCaoNT_NUOC_NGOT_Detail> ReportResults { get; set; }

        [Display(Name = "Tra cứu")]
        public string SearchButton { get; set; }
    }
    public class ViewModelBaoCaoNT_NUOC_NGOT_Detail
    {
        //lồng bè
