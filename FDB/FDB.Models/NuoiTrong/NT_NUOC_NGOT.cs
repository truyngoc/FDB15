...
{
    public class NT_NUOC_NGOT
    {
        public NT_NUOC_NGOT()
        {
            this.DSNT_NuocNgotDetail = new HashSet<NT_NUOC_NGOT_DETAIL>();
        }
        ...
        public virtual ICollection<NT_NUOC_NGOT_DETAIL> DSNT_NuocNgotDetail { get; set; }
    }

    public class NT_NUOC_NGOT_DETAIL
    {
        [Required]
        [Key]
        public int ID { get; set; }
        public int ID_NUOC_NGOT { get; set; }
        public int ID_DOITUONG_NUOI_NGOT { get; set; }
        public int ID_HINHTHUC_NUOI { get; set; }
        public int? SO_LUONG_LONG_LONGBE { get; set; }
        public decimal? THE_TICH_LONG_LONGBE { get; set; }
        public int? MAT_DO_THA_LONGBE { get; set; }
        ...
        [ForeignKey("ID_DOITUONG_NUOI_NGOT"), DatabaseGenerated(DatabaseGeneratedOption.None)]
        public virtual DM_DOITUONG_NUOI_NGOT DM_DoiTuong_Nuoi { get; set; }

        [ForeignKey("ID_NUOC_NGOT"), DatabaseGenerated(DatabaseGeneratedOption.None)]
        public virtual NT_NUOC_NGOT NT_Nuoc_NGOT { get; set; }
